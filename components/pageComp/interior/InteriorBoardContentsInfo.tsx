...
import { iInteriorListItem } from "InterfaceFarm/InteriorBoard";

interface InteriorBoardContentInfoProps {
  dataItem: iInteriorListItem;
  onClick?: (row: iInteriorListItem) => void;
  onDelete?: (row: iInteriorListItem) => void;
}
...
export const InteriorBoardContentsInfo: React.FC<InteriorBoardContentInfoProps> = ({ dataItem, onClick, onDelete }) => {
